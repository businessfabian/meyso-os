...
- [ ] 🤖 Kaltstart von /admin: 1,6 Sekunden ueber dem Latenzboden, und das Buendel ist es nicht. Gemessen am 20.09.2026 gegen Production, drei Runden mit sieben Minuten Ruhe, vorher 1,566 s und nachher 1,607 s ueber dem Boden (/sitemap.xml als statische Latenzroute: 0,128 s vorher, 0,213 s nachher). Der Schnitt von 8,77 auf 2,21 MB hat daran nichts geaendert. Zu suchen ist die Ursache also woanders: die Seite fragt beim Aufbau 37 Mal die Datenbank (Zaehlung aus PR 51, obere Schranke), und eine Runde fra1 nach Supabase eu-west-1 kostet kalt bis 119 ms. Naechster Schritt waere eine Messung, die den Aufbau der Seite in Abfragezeit und Rechenzeit trennt, statt weiter am Buendel zu sparen
