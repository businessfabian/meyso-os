...
- [ ] 🤖 Claude | V6 Felder im Register Bausteine pflegbar: Art, Minuten (nur bei monatlich), Kurztext und zubuchbar als Schalter im Dialog, Art und zubuchbar als Spalten in der Liste, Kurztext als zweite Zeile, Filter auf die freigeschalteten. Keine Migration (PR 60, 09.09.2026, wartet auf Daves Wort)
  <!-- Die vier Spalten gibt es seit 20260908_v6_zubuchen.sql, pflegen liess sich keine: der Dialog kannte sie nicht, die Route reichte sie nicht durch, freigeschaltet wurde mit SQL von Hand. Aktiv und zubuchbar bleiben getrennt, aktiv steuert den Angebotsdialog, zubuchbar das Portal. -->
  <!-- Der Schalter verlangt Preis ueber null und Kurztext. Die Regel steht in lib/zubuchen.ts (darfZubuchbar) und wird in der Route noch einmal geprueft, denn eine Regel nur in der Anzeige ist keine. Drei Faelle aus dem Review: ein PATCH ohne Preis meint den Preis, der schon dasteht, also wird der Stand nach dem Speichern geprueft. Wer Preis oder Kurztext wegnimmt, nimmt den Baustein aus dem Portal, auch ohne den Schalter anzufassen, und der Dialog meldet das vorher. Der Vorab-Read meldet einen Datenbankfehler als 500, nicht als 404. -->
  <!-- Bilder bei 390 und 1120 unter docs/analyse/bausteine, vier Ansichten aus den echten Komponenten. scripts/ansicht-bilder.mjs nimmt die Breiten jetzt als Argument, mit Fensterhoehe (390x1500) fuer Dialoge, die in sich selbst rollen. Suite 2128 gruen, zwei rote Faelle sind Umgebung und auch auf main rot (GITHUB_TOKEN gesetzt, vollstaendiger Build nicht moeglich). Rauchtest lokal gegen next dev: beide Admin-Seiten 200 mit Sitzung, die Route 401 ohne. Der Rauchtest gegen meyso.de gehoert nach dem Deploy. -->
