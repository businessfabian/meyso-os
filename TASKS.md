...
- [ ] 🤖 Waechterpruefung 24: angenommenes Angebot ohne Auftrag, ausser bei Demokunden, damit der Zustand bei einem echten Kunden auffaellt. Dafuer kennt der Auftrag sein Angebot (neue Spalte auftraege.angebot_id, gesetzt bei der Annahme auf allen drei Wegen), bisher stand die Verbindung nur ueber den Deal fest (24.09.2026, PR 82 offen, Migration und Merge nach Daves Wort)
...
- [ ] 👤 Dave | Migration 20260924_auftraege_angebot.sql im SQL-Editor einspielen (PR 82), danach die Katalog-Nachher-Liste aus dem Kopf der Datei. Additiv: eine Spalte, ein Fremdschluessel, ein Index. Erst die Migration, dann der Merge, denn der neue Code schreibt angebot_id bei jeder Annahme
- [ ] 👤 Dave | PR 82 (Waechterpruefung 24) entscheiden
