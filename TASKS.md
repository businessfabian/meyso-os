...
- [ ] 🤖 Tests mit Draht nach draussen getrennt (PR 45, offen): kosten-konsistenz nach __tests__/netz, eigener Befehl npm run test:netz, Wache ueber die Grenze im Standardlauf
