...
- [ ] 🤖 Playwright als devDependency, dazu ein Skript, das aus next start Bilder bei 390, 1120 und 1920 Pixeln aufnimmt. Pflicht fuer jeden Gestaltungs-PR: ohne Bild aus dem echten Build kein Merge. Der Tailwind-Hotfix waere sonst nicht aufgefallen, die Ansichten liefen mit CDN-CSS und sahen richtig aus, waehrend Production ohne Layout dastand
...
- [ ] 🤖 V6 (naechstes) Zubuchen: der Kunde bucht Minuten dazu, wenn das Monatsbudget aufgebraucht ist. Grundlage steht mit V5 (client_contracts.minuten_monat ist die fuehrende Angabe je Vertrag, Waechter 16 meldet das leere Budget schon, tut aber nichts)
