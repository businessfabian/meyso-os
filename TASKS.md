...
- [ ] 🤖 Fristen auf HEUTE: dringende Fristen aus Dokumenten und Lieferantenvertraegen stehen als Punkte da, nur fuer Rollen mit unternehmen.sehen (23.09.2026, PR 77, gebaut, Migration und Merge nach Daves Wort) Ueberfaellig ist kritisch, ab 14 Tagen vor der Frist handeln, davor bleibt es ein Termin. Der Punkt fuehrt in das Register, in dem die Frist gepflegt wird. Aufgefallen am 21.09.2026 in Tempo 4, dort bewusst nicht geaendert
...
- [ ] 👤 Dave | PR 77 (Fristen auf HEUTE) entscheiden: Migration 20260923_heute_fristen.sql einspielen und mergen, Reihenfolge frei. Danach Rauchtest, Sichtbarkeitslauf und der Netz-Test (npm run test:netz), der erst mit der Migration gruen wird
...
- [ ] 🤖 __tests__/portal-mandanten.test.ts faellt unter Last im Aufbau (hookTimeout 20 s, PGlite), einzeln laeuft die Datei mit 60 Tests gruen. Dieselbe Sache wie bei den zwei E-Rechnungstests. Grenze am Aufbau anheben, wie in heute-dashboard.test.ts (60 s)
