...
- [ ] 🤖 V3 Rest: Widerspruch erste Faelligkeit. Einziger Punkt der alten V3-Zeile, der nicht im Auftrag stand und nicht gebaut ist. Vor der Umsetzung festlegen, was gemeint ist. Lesart hier: ein Waechter, der meldet, wenn next_invoice_due dem Vertrag widerspricht, also vor dem Beginn liegt oder mehr als ein Intervall dahinter. Beispiel im Bestand: VT-2026-005 steht auf beendet und traegt trotzdem next_invoice_due 01.10.2026
...
- [ ] 👤 Dave | Entscheidung zu Rechnung 2026-015 (Problemlos, 20 Euro, faellig 15.09.2026, offen): der Vertrag VT-2026-005 ist am 07.09.2026 mit dem Grund "versehentlich angelegt" beendet worden, die Rechnung deckt aber den ganzen September. Sie ist am 01.09.2026 festgeschrieben, also nicht loeschbar (Paragraf 147 AO), der Weg waere ein Storno mit Grund. Ab dem 16.09. steht sie sonst als ueberfaellig im Waechter, bei einem Kunden mit der E-Mail "t"
...
- [ ] 🤖 Stufe 2 als allgemeine zweite Erinnerung (PR 43, offen): Verweis auf § 7 Abs. 4 statt § 14 Abs. 5, der Sperrabsatz nur bei zwei aufeinanderfolgenden Vertragsrechnungen, Betreffzeilen "Zahlungserinnerung" und "Zweite Zahlungserinnerung" mit Rechnungsnummern
  <!-- Korrektur an PR 42. Dort war Stufe 2 die Sperrankuendigung selbst, damit bekam ein Kunde mit einer offenen Projektrechnung nie eine zweite Erinnerung: Paragraf 14 Absatz 5 spricht nur von Dauerleistungen. Beide Paragrafen sind jetzt gegen lib/agb.ts geprueft. Kein Betrag fuer Zinsen oder Pauschale in der Mail. -->
...
- [ ] 👤 Anschrift von Ziegler Holzarbeiten nachtragen (Strasse, PLZ, Ort). Ohne sie lehnt das Festschreiben jeden Beleg ab, und zwar bevor der Steuervermerk ueberhaupt zur Sprache kommt. Aufgefallen im Trockenlauf am 09.09.2026
