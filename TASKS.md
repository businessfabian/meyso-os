...
- [ ] 🤖 Die zwei E-Rechnungstests (erechnung.test.ts "zieht das eingebettete XML aus dem PDF", erechnung-buchung.test.ts "belegt aus dem ZUGFeRD-Beispiel alle Felder vor") laufen unter Last in die Zeitueberschreitung. Einzeln brauchen sie 1,4 s, im vollen Lauf neben einem Rauchtest 9 bis 23 s. Dreimal am 22.09.2026 passiert. Entweder die Grenze fuer diese beiden Faelle anheben oder die PDF-Extraktion einmal je Datei machen
...
- [ ] 👤 Dave | PR 76 (Minuten beim Artwechsel) entscheiden: Merge, keine Migration
