...
- [ ] 🤖 V3 dazu: Leistungszeitraum bei Anzahlungsraten. Auf einer Anzahlung steht heute ein Kalendermonat, obwohl in diesem Monat nichts geleistet wurde. Ersetzen durch den Satz "Anzahlung, Abrechnung des Leistungszeitraums mit der Schlussrechnung". Die Vorbelegung mit dem Kalendermonat gilt danach nur noch fuer Wartung und Hosting
...
- [ ] 🤖 V11 Regelbesteuerung, zusammen mit V10 E-Rechnung. Ausgeloest wird sie vom Waechter: sobald Pruefung 4 die 50 Prozent der Vorjahresgrenze meldet, ist es Zeit zu planen, nicht erst beim Ueberschreiten. Inhalt: Schalter mit Datum (ab wann Regelbesteuerung gilt, rueckwirkend nichts aendern), Steuerblock auf allen Belegen (Netto, Satz, Steuerbetrag, Brutto), Vorsteuer an den Ausgaben, EU mit Reverse Charge und damit auch das Ende der EU-Sperre aus V7
  ...
  <!-- V10 E-Rechnung hat in dieser Datei noch keine Zeile. Dave hat sie am 09.09.2026 genannt, den Inhalt aber nicht. Vor dem Start beider Etappen bitte nachtragen, was V10 umfassen soll: die beiden haengen zusammen, weil eine E-Rechnung nach EN 16931 die Steuerangaben braucht, die es vor der Regelbesteuerung gar nicht gibt. -->
---
